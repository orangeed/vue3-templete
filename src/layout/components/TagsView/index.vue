          ...
          <Draggable :list="tabsList" animation="300" item-key="fullPath" class="flex">
            <template #item="{ element }">
              <div
                ...
                :class="{
                  'active-item': activeKey === element.path && !isDark,
                  'active-item-dark': activeKey === element.path && isDark,
                  'tabs-card-scroll-item-dark': isDark === true,
                  'tabs-card-scroll-item': isDark === false,
                }"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    console.log('designStore', designStore);
    ...
    const infoColorSuppl = computed(() => {
      return themeVars.value.infoColorSuppl;
    });
...
.tabs-view {
  ...
  &-main {
    ...
    min-width: 100%;
    padding: 0 16px;
    background-color: v-bind(getCardColor);
    ...
    .tabs-card {
      ...
      &-scroll {
        ...
        .active-item {
          color: v-bind(getAppTheme);
          // background-color: v-bind(infoColorSuppl);
